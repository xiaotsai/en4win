...
//go:linkname reflect_makemap reflect.hxEiL_K1Bf
...
//go:linkname reflect_mapaccess reflect.unynMPYi
...
//go:linkname reflect_mapaccess_faststr reflect.bjogv5
...
//go:linkname reflect_mapassign reflect.ysYaaSlj
func reflect_mapassign(t *maptype, h *hmap, key unsafe.Pointer, elem unsafe.Pointer) {
	p := mapassign(t, h, key)
	typedmemmove(t.Elem, p, elem)
}

//go:linkname reflect_mapassign_faststr reflect.lJ9j4Ry
func reflect_mapassign_faststr(t *maptype, h *hmap, key string, elem unsafe.Pointer) {
	p := mapassign_faststr(t, h, key)
	typedmemmove(t.Elem, p, elem)
}

//go:linkname reflect_mapdelete reflect.a0tirBasjs
func reflect_mapdelete(t *maptype, h *hmap, key unsafe.Pointer) {
	mapdelete(t, h, key)
}

//go:linkname reflect_mapdelete_faststr reflect.um8hBA
func reflect_mapdelete_faststr(t *maptype, h *hmap, key string) {
	mapdelete_faststr(t, h, key)
}

//go:linkname reflect_mapiterinit reflect.gRAVyD
func reflect_mapiterinit(t *maptype, h *hmap, it *hiter) {
	mapiterinit(t, h, it)
}

//go:linkname reflect_mapiternext reflect.i5Fv9sOiLwR
func reflect_mapiternext(it *hiter) {
	mapiternext(it)
}

//go:linkname reflect_mapiterkey reflect.cgg9ghkrEjoF
func reflect_mapiterkey(it *hiter) unsafe.Pointer {
	return it.key
}

//go:linkname reflect_mapiterelem reflect.tW5jaa7
func reflect_mapiterelem(it *hiter) unsafe.Pointer {
	return it.elem
}

//go:linkname reflect_maplen reflect.n6Tt0Kac
...
//go:linkname reflect_mapclear reflect.vuwNVEmTRp
func reflect_mapclear(t *maptype, h *hmap) {
	mapclear(t, h)
}

//go:linkname reflectlite_maplen yAj8QghzkR.h5VXr0f1C
...
//
//go:linkname mapclone tduD845UpefY.uh_b0Ai
...
//
//go:linkname keys tduD845UpefY.p6aBr2UHjLeI
...
//
//go:linkname values tduD845UpefY.zjMmboD7TmgW
