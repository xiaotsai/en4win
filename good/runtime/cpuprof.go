...
func SetCPUProfileRate(hz int) {
	...
	if hz > 0 {
		if cpuprof.on || cpuprof.log != nil {
			hidePrint("runtime: cannot set cpu profile rate until previous profile has finished.\n")
			unlock(&cpuprof.lock)
			return
		}
...
//go:linkname runtime_pprof_runtime_cyclesPerSecond l4ycaydqJMa.qEN8Nc8Vuh
...
//
//go:linkname runtime_pprof_readProfile l4ycaydqJMa.gYnwyZyHVS
