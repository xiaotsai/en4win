...
//go:linkname sync_atomic_StorePointer sync/atomic.Fa2hd0oXquKk
//go:nosplit
...
//go:linkname sync_atomic_SwapPointer sync/atomic.X8DfWh
//go:nosplit
...
//go:linkname sync_atomic_CompareAndSwapPointer sync/atomic.B2CfK2wiOXKp
//go:nosplit
