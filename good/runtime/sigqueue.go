...
//
//go:linkname signal_recv hk_fei67p.hyUPp_
...
//
//go:linkname signalWaitUntilIdle hk_fei67p.cWauwV2YZro4
...
// Must only be called from a single goroutine at a time.
//
//go:linkname signal_enable hk_fei67p.oy7jBxR4
...
// Must only be called from a single goroutine at a time.
//
//go:linkname signal_disable hk_fei67p.hKnXq6UNq
...
// Must only be called from a single goroutine at a time.
//
//go:linkname signal_ignore hk_fei67p.g9BcD9b
...
//
//go:linkname signal_ignored hk_fei67p.lQxbyV8bX
