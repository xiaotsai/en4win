...
//go:linkname syscall_runtime_envs bUKeamF.tNVU83vFDm
func syscall_runtime_envs() []string	{ return append([]string{}, envs...) }

//go:linkname syscall_Getpagesize bUKeamF.FLKDEa
func syscall_Getpagesize() int	{ return int(physPageSize) }

//go:linkname os_runtime_args hPMrClpC.kvYaar24hG
func os_runtime_args() []string	{ return append([]string{}, argslice...) }

//go:linkname syscall_Exit bUKeamF.QcqSaNcYkFmT
//go:nosplit
...
//go:linkname godebug_setUpdate rayT9AgS.ra_sJbHdPGkQ
...
//go:linkname godebug_setNewIncNonDefault rayT9AgS.vTCjjoHu
...
//go:linkname syscall_runtimeSetenv bUKeamF.gb9l485q7
...
//go:linkname syscall_runtimeUnsetenv bUKeamF.aCtW2ffDj
...
var // accessed from x/sys/cpu; see issue 57336
_ = atomic.And
