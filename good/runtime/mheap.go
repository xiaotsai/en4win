...
func (h *mheap) grow(npage uintptr) (uintptr, bool) {
	...
	if nBase > h.curArena.end || /* overflow */ end < h.curArena.base {
		...
		if av == nil {
			...
			hidePrint("runtime: out of memory: cannot allocate ", ask, "-byte block (", inUse, " in use)\n")
			return 0, false
		}
...
func (h *mheap) freeSpanLocked(s *mspan, typ spanAllocType) {
	...
	case mSpanInUse:
		...
		if s.allocCount != 0 || s.sweepgen != h.sweepgen {
			hidePrint("mheap.freeSpanLocked - span ", s, " ptr ", hex(s.base()), " allocCount ", s.allocCount, " sweepgen ", s.sweepgen, "/", h.sweepgen, "\n")
...
//go:linkname runtime_debug_freeOSMemory G1I6Ii.bDmgIJP464b
...
func (list *mSpanList) remove(span *mspan) {
	if span.list != list {
		hidePrint("runtime: failed mSpanList.remove span.npages=", span.npages,
...
func (list *mSpanList) insert(span *mspan) {
	if span.next != nil || span.prev != nil || span.list != nil {
		hidePrint("runtime: failed mSpanList.insert", span, span.next, span.prev, span.list)
...
func (list *mSpanList) insertBack(span *mspan) {
	if span.next != nil || span.prev != nil || span.list != nil {
		hidePrint("runtime: failed mSpanList.insertBack", span, span.next, span.prev, span.list)
