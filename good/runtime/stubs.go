...
//go:linkname reflect_memclrNoHeapPointers reflect.lUjiI4Wb_
...
//go:linkname reflect_memmove reflect.pqAEZr6n
...
//go:linkname rand_fastrand64 os208GicmRnc.ahgDR305a
func rand_fastrand64() uint64	{ return fastrand64() }

//go:linkname sync_fastrandn sync.q3i2dA
func sync_fastrandn(n uint32) uint32	{ return fastrandn(n) }

//go:linkname net_fastrandu gF9mZs2.eUeRcLk
func net_fastrandu() uint	{ return fastrandu() }

//go:linkname os_fastrand hPMrClpC.ax5_HC
